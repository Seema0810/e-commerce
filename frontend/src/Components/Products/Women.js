...
const Women = () => {
  ...
  return (
    <div>
      {" "}
      <div className="bg-light container-fluid product-page-m" style={{marginTop:"5rem"}}>
    ...
    <div className="col-lg-3 col-md-4 col-sm-12"  key={product._id}>
      <Link to={`/singleproduct/${product._id}`}>
        ...
        <div className="card-body">
          <h6 className="card-title text-center text-primary">{product.title}</h6>
          <div className="card-text">
               <p> <i class="fa-solid fa-star text-warning"></i>
                ...
                <i class="fa-solid fa-star text-warning"></i>
                <i class="fa-solid fa-star text-warning"></i>
                <span className="text-danger mx-1">5.3 reviews</span></p>
            <p className="float-start "><b>${product.price}</b></p>
            <br/>
            <p className="float-start d-block">{product.description.slice(0, 50)}...</p>
          </div>
